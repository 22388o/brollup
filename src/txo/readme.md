...
The transactional structure of the Bitcoin Virtual Machine consists of 10 different kinds of lego pieces, otherwise known as transaction output (TXO) types:
