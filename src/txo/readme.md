...
Bitcoin Virtual Machine advance the rollup state by chanining `Pool Transactions` at regular intervals. The transactional structure of the `Pool Transaction` consists of 10 transaction output (TXO) types:
